 ...
 *
 */
const { typeRouter } = require('./controllers/movietype.js')
const { movieRouter } = require('./controllers/movielist.js')
const { watchRouter } = require('./controllers/watch.js')
...
app.use('/api/types/:typeId/movies', movieRouter)
